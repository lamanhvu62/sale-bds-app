...
export default function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 glass-effect border-t border-white/5 px-2 py-3 flex justify-around items-center max-w-lg mx-auto z-40 rounded-t-[24px]">
      {navItems.map((item) => {
        ...
        return (
          <button
            ...
            className={`flex flex-col items-center gap-1.5 px-4 py-1 rounded-xl transition-all duration-300 relative ${
